...
Sys.UI.Template._inputRequiredAttributes = {"type":1, "name":1};
...
Sys.UI.TemplateContext = function Sys$UI$TemplateContext() {
    ...
    function Sys$UI$TemplateContext$_find(selector, single) {
            ...
            this._findById(selector.substr(0, 1), selector.substr(1)) :
            Sys._find(selector, this.nodes, single);
    }
    function Sys$UI$TemplateContext$_findById(kind, id) {
        var element = null;
        for (var context = this; !element && context; context = context.parentContext) {
            ...
            if (context._global) {
                ...
                return element || Sys.get(kind + id);
    }
        ...
        ///// begin element activation
            ...
            for (j = alength; j >= 0; j--) {
                ...
                case "sys:command":
                    ...
                    Sys.UI.DomElement.setCommand(element, command||"", commandArg||null, commandTarget||null);
                    break;
                default:
